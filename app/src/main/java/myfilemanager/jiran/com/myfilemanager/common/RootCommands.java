...
public class RootCommands {
    ...
    public static ArrayList<FileItem> listFiles(String path, boolean showhidden) {
        ArrayList<FileItem> content = new ArrayList<>();
        ...
        for (String i : items) {
            FileItem item = MainActivity.mMds.checkFile(path + "/" + i);
            if(item == null){
                item = new FileItem();
                item.setPath(path + "/" + i);
                item.setTagId("");
