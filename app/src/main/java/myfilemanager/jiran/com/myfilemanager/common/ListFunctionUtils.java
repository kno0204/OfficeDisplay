...
//            boolean root = false;//Settings.rootAccess();
//
...
//        }
        ...
        public static ArrayList<FileItem> listFiles(String path, Context c) {
            ArrayList<FileItem> mDirContent = new ArrayList<>();
            boolean showhidden = Settings.getShowHiddenFiles();//Settings.showHiddenFiles();
    ...
    public static ArrayList<FileItem> listTagFiles(TagItem tag, Context c) {
        ArrayList<FileItem> mDirContent = new ArrayList<>();
        mDirContent = MainActivity.mMds.selectTagFiles(tag.getId());
    ...
    public static ArrayList<FileItem> listFavoriteFiles(Context c) {
        ArrayList<FileItem> mDirContent = new ArrayList<>();
        mDirContent = MainActivity.mMds.selectFavoriteFiles();
